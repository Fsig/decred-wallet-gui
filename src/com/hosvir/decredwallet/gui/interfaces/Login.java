...
public class Login extends Interface {
    ...
    public void init() {
        ...
        Dialog errorDialog = new com.hosvir.decredwallet.gui.Dialog("errordiag", "");
    ...
    public void render(Graphics2D g) {
        ...
        if (Constants.isTestnet()) {
            ...
            g.drawString(Constants.getTestnetWarning(), (Engine.getWidth() / 2) - ((g.getFontMetrics().stringWidth(Constants.getTestnetWarning())) / 2), 60);
        }
