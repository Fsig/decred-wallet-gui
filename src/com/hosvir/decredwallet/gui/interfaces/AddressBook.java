...
public class AddressBook extends Interface implements MouseWheelListener {
    ...
    @Override
    public void init() {
        this.components.add(new Button("add", Constants.getLangValue("Add-Button-Text"), 20, 80, 100, 35, ColorConstants.flatBlue, ColorConstants.flatBlueHover));
    ...
    public void render(Graphics2D g) {
        ...
        for (int i = 0; i < Constants.contacts.size(); i++) {
            if (150 + i * 70 - scrollOffset < Engine.getHeight() && 150 + i * 70 - scrollOffset > 80) {
                ...
                //Draw name
                if (hoverId == Constants.contacts.size() + i) g.setColor(ColorConstants.flatBlue);
                ...
                //Email
                if (hoverId == (Constants.contacts.size() * 2) + i) g.setColor(ColorConstants.flatBlue);
                ...
                //Address
                if (hoverId == (Constants.contacts.size() * 3) + i) g.setColor(ColorConstants.flatBlue);
                else g.setColor(ColorConstants.walletBalanceColor);
    ...
    public void mouseWheelMoved(MouseWheelEvent e) {
        if (isActive()) {
            ...
            if (scrollOffset > (Constants.contacts.size() - 1) * 70)
                scrollOffset = (Constants.contacts.size() - 1) * 70;
