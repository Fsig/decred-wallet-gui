...
public class AddContact extends Interface {
    public void init() {
        ...
        this.components.add(new com.hosvir.decredwallet.gui.Label("nameLabel", Constants.getLangValue("Name-Label"), (Engine.getWidth() / 2) - 340, (Engine.getHeight() / 2) - 30));
        this.components.add(new com.hosvir.decredwallet.gui.Label("emailLabel", Constants.getLangValue("Email-Label"), (Engine.getWidth() / 2) - 340, (Engine.getHeight() / 2) +10));
        this.components.add(new com.hosvir.decredwallet.gui.Label("addressLabel", Constants.getLangValue("Address-Label"), (Engine.getWidth() / 2) - 340, (Engine.getHeight() / 2) + 50));
        ...
        this.components.add(new com.hosvir.decredwallet.gui.Button("cancel", Constants.getLangValue("Cancel-Button-Text"), 30, (Engine.getHeight() / 2) + 70, 100, 35, ColorConstants.flatRed, ColorConstants.flatRedHover));
        this.components.add(new com.hosvir.decredwallet.gui.Button("confirm", Constants.getLangValue("Confirm-Button-Text"), Engine.getWidth() - 130, (Engine.getHeight() / 2) + 70, 100, 35, ColorConstants.flatBlue, ColorConstants.flatBlueHover));
    }
