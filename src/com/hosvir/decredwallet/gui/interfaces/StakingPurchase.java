...
public class StakingPurchase extends Interface {
    ...
    @Override
    public void init() {
        this.components.add(new com.hosvir.decredwallet.gui.Label("from", Constants.getLangValue("From-Label"), 40, 190));
        this.components.add(new com.hosvir.decredwallet.gui.Label("limit", Constants.getLangValue("Limit-Label"), 40, 240));
        this.components.add(new com.hosvir.decredwallet.gui.Label("fee", Constants.getLangValue("Transaction-Fee-Label"), 40, 290));
        this.components.add(new com.hosvir.decredwallet.gui.Label("address", Constants.getLangValue("Address-Label"), 40, 340));
        this.components.add(new com.hosvir.decredwallet.gui.Label("tickets", Constants.getLangValue("Ticket-Count-Label"), 40, 390));
        this.components.add(new com.hosvir.decredwallet.gui.Label("pooladdr", Constants.getLangValue("Pool-Address-Label"), 40, 440));
        this.components.add(new com.hosvir.decredwallet.gui.Label("poolfee", Constants.getLangValue("Pool-Fee-Label"), 40, 490));
        ...
        this.components.add(new com.hosvir.decredwallet.gui.Button("cancel", Constants.getLangValue("Cancel-Button-Text"), 40, 520, 100, 35, ColorConstants.flatRed, ColorConstants.flatRedHover));

        com.hosvir.decredwallet.gui.Button confirmButton = new com.hosvir.decredwallet.gui.Button("confirm", Constants.getLangValue("Confirm-Button-Text"), Engine.getWidth() - 140, 520, 100, 35, ColorConstants.flatBlue, ColorConstants.flatBlueHover);
    ...
    public void update(long delta) {
        ...
        if(!blockInput){
            ...
            if(getComponentByName("limitInput").text == "" || (Constants.globalCache.stakeInfo.size() > 0 &&
                    Double.valueOf(getComponentByName("limitInput").text) != Double.valueOf(String.valueOf(Constants.globalCache.stakeInfo.get("difficulty"))))) {
