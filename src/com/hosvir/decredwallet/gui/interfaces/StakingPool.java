...
public class StakingPool extends Interface {
	...
	public void init() {		
		...
		this.components.add(new Button("getpublickey", Constants.getLangValue("Get-Public-Key-Button-Text"), Engine.getWidth() - 240, 168, 200, 35, ColorConstants.flatBlue, ColorConstants.flatBlueHover));
		this.components.add(new Button("import", Constants.getLangValue("Import-Button-Text"), Engine.getWidth() - 140, 218, 100, 35, ColorConstants.flatBlue, ColorConstants.flatBlueHover));
